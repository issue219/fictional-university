...
class Search {
  constructor() {
    // alert('OK');
    // Lay icon search
    this.openSearch = jquery__WEBPACK_IMPORTED_MODULE_0___default()('.search-trigger');

    // Lay nut close search
    this.closeSearch = jquery__WEBPACK_IMPORTED_MODULE_0___default()('.search-overlay__close');
